<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">     <!--使用v-if当info中的supports存在时就会显示-->
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]">     <!--        因为info为异步调用 因此当页面加载完毕时可能没有数据 所以需要使用v-if 在三态链式时而且为空时会发生错误-->
          <span class="content-tag">
